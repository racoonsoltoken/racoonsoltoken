...
async function main(){
    ...
    const myKeypair = loadWalletKey("SD2TAnSosLSQaj9e5Y4TAXKDZ3AqYLjLsp6ZXqUsvk9.json");
    const mint = new web3.PublicKey("SD2TAnSosLSQaj9e5Y4TAXKDZ3AqYLjLsp6ZXqUsvk9");
